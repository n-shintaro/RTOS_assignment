...
void *task1( void *ptr)
{
	...
	pthread_setaffinity_np(pthread_self(), sizeof(cpu_set_t), &cset);
  	...
  	for (i=0; i < 100; i++)
		...
		next_arrival_time[1].tv_sec= next_arrival_time[0].tv_sec + next_arrival_nanoseconds/1000000000;
    	}
}
...
void *task2( void *ptr )
{
	...
	int i=0;
  	for (i=0; i < 100; i++)
		...
		long int next_arrival_nanoseconds = next_arrival_time[2].tv_nsec + periods[1];
		next_arrival_time[2].tv_nsec= next_arrival_nanoseconds%1000000000;
		next_arrival_time[2].tv_sec= next_arrival_time[1].tv_sec + next_arrival_nanoseconds/1000000000;
    	}
}
